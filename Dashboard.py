...
app.layout = html.Div([
    html.H1("Automobile Sales Statistics Dashboard", style={'textAlign': 'center', 'color': '#503D36', 'font-size': '30px'}),
    html.Div([
        ...
        dcc.Dropdown(
            ...
            style={'width': '80%', 'margin': 'auto', 'padding': '3px', 'fontSize': '20px',
    ...
    html.Div(dcc.Dropdown(
        ...
        style={'width': '80%', 'margin': 'auto', 'padding': '3px', 'fontSize': '20px', 'textAlignLast': 'center', 'borderRadius': '10px', 'fontFamily': 'Arial, sans-serif'},
        value='Select a year'
    )),
    html.Div([
